...
<html>
    ...
    <body>
        ...
        <div id="show-pizza" class="content scaffold-show" role="main">
            ...
            <f:display bean="pizza" />
            <g:form resource="${this.pizza}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.pizza}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
