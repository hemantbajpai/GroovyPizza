...
<html>
    ...
    <body>
        ...
        <div id="show-dessert" class="content scaffold-show" role="main">
            ...
            <f:display bean="dessert" />
            <g:form resource="${this.dessert}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.dessert}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
